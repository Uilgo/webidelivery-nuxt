...
/**
 * 📊 PedidoAvaliacaoDesktop - Modal para avaliar pedido (Desktop)
 */
...
<template>
	<UiModal v-model="isOpen" size="md" :show-close-button="false">
		<!-- Header customizado -->
		<template #header>
			<div class="flex items-center justify-between w-full">
				...
				<button
					type="button"
					class="flex items-center justify-center p-2 rounded-full hover:bg-[var(--cardapio-muted)] transition-colors"
					@click="emit('fechar')"
				>
		...
		<template #footer>
			<div class="flex justify-end gap-3">
				<UiButton color="neutral" variant="outline" :disabled="loading" @click="emit('fechar')">
					Cancelar
				</UiButton>
				<UiButton
					color="primary"
